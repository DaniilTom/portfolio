...
namespace WebStore.DAL.Migrations
{
    ...
    [Migration("20190425073451_OrderAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebStore.Domain.Implementations.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("WebStore.Domain.Implementations.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("WebStore.Domain.Implementations.ProductBase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("WebStore.Domain.Implementations.Microcontroller", b =>
                {
                    b.HasBaseType("WebStore.Domain.Implementations.ProductBase");

                    b.ToTable("Microcontrollers");

                    b.HasDiscriminator().HasValue("Microcontroller");
                });
            ...
            modelBuilder.Entity("WebStore.Domain.Implementations.OrderItem", b =>
                {
                    b.HasOne("WebStore.Domain.Implementations.Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId");

                    b.HasOne("WebStore.Domain.Implementations.ProductBase", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId");
                });
